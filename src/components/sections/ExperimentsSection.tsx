...
export const ExperimentsSection = () => (
  <section id="experiments" className="scroll-section mt-16 rounded-3xl border border-white/10 bg-surface px-6 py-12 shadow-[0_20px_60px_rgba(0,0,0,0.4)] md:px-10">
    <SectionTitle
      label="Песочница"
      title="Эксперименты"
      description="Небольшие визуальные исследования: движущиеся узлы, орбиты частиц и светящаяся сетка. Без тяжёлого WebGL, только Canvas и CSS."
    />
